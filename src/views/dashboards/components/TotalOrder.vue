            ...
            <div class="d-flex align-start mb-3">
                ...
                <div class="ml-auto z-1">
                    <v-tabs v-model="tab" class="theme-tab" density="compact" align-tabs="end">
                        <v-tab value="1" hide-slider color="transparent">Месяц</v-tab>
                        <v-tab value="2" hide-slider color="transparent">Год</v-tab>
                    </v-tabs>
                </div>
            </div>
                ...
                <v-tabs-window-item value="2">
                    <v-row>
                        <v-col cols="6">
                            ...
                            <span class="text-subtitle-1 text-medium-emphasis text-white">Итого заказов</span>
                        </v-col>
                        <v-col cols="6">
